...
def createDb():
    ...
    cur = conn.cursor()
    sqlstr1 = 'create table questiontable (id integer primary key, \
        questionhtml varchar(1000), \
    ...
    sqlstr2 = 'create table categorytable (id integer primary key,  category varchar(100))'
    sqlstr3 = 'create table questypetable (id integer primary key,  questiontype varchar(50))'
    sqlstr4 = 'create table yearstable (id integer primary key,  whichyear varchar(20))'

    sqlstr5 = 'create table usertable (id integer primary key,  \
        username varchar(20), \
        password varchar(20), \
